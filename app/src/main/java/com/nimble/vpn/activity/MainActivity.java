...
import com.nimble.vpn.MainApplication;
import com.nimble.vpn.dialog.CommentBottomSheetDialog;
import com.nimble.vpn.dialog.CountryData;
import com.nimble.vpn.dialog.LoginDialog;
import com.nimble.vpn.dialog.RegionChooserDialog;
...
public class MainActivity extends UIActivity implements TrafficListener, VpnStateListener, LoginDialog.LoginConfirmationInterface, RegionChooserDialog.RegionChooserInterface {
    ...
    protected void onStart() {
        ...
        commentBottomSheetDialog = CommentBottomSheetDialog.getInstance(this);
    }
    ...
    public void handleError(Throwable e) {
        if (e instanceof NetworkRelatedException) {
            ...
            if (e instanceof VpnPermissionRevokedException) {
                showMessage("User revoked vpnapp permissions");
            } else if (e instanceof VpnPermissionDeniedException) {
                showMessage("User canceled to grant vpnapp permissions");
                ...
                if (hydraVpnTransportException.getCode() == HydraVpnTransportException.HYDRA_ERROR_BROKEN) {
                    showMessage("Connection with vpnapp server was lost");
